...
export interface DetalleServicio {
  ...
  img?: string          // Imagen específica del card (override de data.img global)
}
...
export const SERVICIO_PAGES: Record<string, ServicioData> = {
  ...
  'venta-equipos': {
    ...
    detalles: [
      { nombre: 'Extintores certificados NOM-154', sub: 'Más de 10 tipos disponibles: PQS, CO₂, AFFF, Tipo K, agente limpio y Cold Fire — con ficha técnica y certificado incluidos', href: '/extintores/', img: '/imagenes/extintores/extintor-pqs-bodega-industrial-zona-cdmx.avif' },
      { nombre: 'Señalamientos fotoluminiscentes', sub: 'Visibles sin electricidad, fabricados conforme a NOM-003-SEGOB y NOM-026-STPS para rutas de evacuación y zonas de riesgo', href: '/senalamientos/', img: '/imagenes/senalamientos/senalamientos-hero.jpg' },
      { nombre: 'Equipo profesional para bomberos', sub: 'Trajes estructurales NFPA 1971, equipos de respiración autónoma y herramientas de rescate hidráulico certificadas', href: '/equipo-bomberos/', img: '/imagenes/equipo-bomberos/trajes-estructurales-nfpa-1971.avif' },
      { nombre: 'Gabinetes contra incendio', sub: 'Gabinetes para extintor, hidrante y bombero en acero al carbón — acceso rápido en emergencias conforme a normativa vigente', href: '/gabinetes/', img: '/imagenes/gabinetes/gabinetes-hero.jpg' },
      { nombre: 'Mangueras y accesorios hidráulicos', sub: 'Chiflones, válvulas angulares, carretes, tomas siamesas y monitores Elkhart Brass para redes contra incendio', href: '/mangueras/', img: '/imagenes/mangueras/mangueras-hero.jpg' },
      { nombre: 'Sistemas de detección y supresión', sub: 'Alarmas NFPA 72, detectores de humo, rociadores automáticos y tableros de control con monitoreo remoto', href: '/sistemas/', img: '/imagenes/sistemas/alarmas.jpg' },
    ],
  ...
  'recarga-extintores': {
    ...
    detalles: [
      { nombre: 'Recarga de extintor PQS / ABC',    sub: 'El agente más utilizado en México — ideal para oficinas, bodegas, comercios y vehículos con collar de garantía incluido', href: '/extintores/polvo-seco/', img: '/imagenes/extintores/extintor-polvo-seco-pqs-instalado-oficina-cdmx.avif' },
      { nombre: 'Recarga de extintor CO₂',          sub: 'Protección sin residuos para servidores, laboratorios y equipos electrónicos sensibles — no daña componentes', href: '/extintores/co2/', img: '/imagenes/extintores/extintor-co2-dioxido-carbono-equipo-electrico-cdmx.avif' },
      { nombre: 'Recarga de extintor AFFF / Espuma', sub: 'Agente filmógeno para líquidos inflamables en talleres, gasolineras y plantas industriales', href: '/extintores/afff/', img: '/imagenes/extintores/extintor-afff-espuma-mecanica-liquidos-inflamables.avif' },
      { nombre: 'Recarga de extintor Tipo K',       sub: 'Formulado para aceites de cocina y freidoras — obligatorio en restaurantes y cocinas industriales por norma', href: '/extintores/tipo-k/', img: '/imagenes/extintores/extintor-tipo-k-cocina-industrial-restaurante.avif' },
      { nombre: 'Recarga de extintor agente limpio', sub: 'Protección certificada para centros de datos, archivos históricos y salas con equipos de alto valor', href: '/extintores/agente-limpio/', img: '/imagenes/extintores/extintor-agente-limpio-fe36-sin-residuos.avif' },
      { nombre: 'Recarga de extintores automáticos', sub: 'Sistemas de activación autónoma que responden sin intervención humana — ideales para áreas desatendidas', img: '/imagenes/extintores/extintor-automatico-proteccion-areas-desatendidas.avif' },
    ],
    normasEyebrow: 'Cumplimiento normativo',
  ...
  'mantenimiento-preventivo': {
    ...
    detalles: [
      { nombre: 'Inspección periódica programada',    sub: 'Visitas mensuales o trimestrales adaptadas al nivel de riesgo y tipo de instalación — nunca pierdas una fecha límite', img: '/imagenes/escenarios/oficina.avif' },
      { nombre: 'Verificación de presión y agente',   sub: 'Revisión profesional de manómetro, peso del agente extintor y estado de válvulas para garantizar operación inmediata', img: '/imagenes/extintores/extintor-polvo-seco-pqs-instalado-oficina-cdmx.avif' },
      { nombre: 'Actualización de etiquetas NOM',     sub: 'Renovación de etiquetas de inspección, bitácoras y registros exigidos por Protección Civil y STPS', img: '/imagenes/extintores/venta-extintor-pqs-abc-certificado-nom-mexico.avif' },
      { nombre: 'Reportes técnicos documentados',     sub: 'Informes detallados con hallazgos, recomendaciones y evidencia fotográfica — listos para cualquier auditoría', img: '/imagenes/servicios/asesoria-tecnica-proteccion-civil-dictamen-seguridad.avif' },
      { nombre: 'Diagnóstico preventivo de fallas',   sub: 'Detectamos corrosión, fugas y desgaste antes de que se conviertan en observaciones durante inspecciones oficiales', img: '/imagenes/escenarios/industrial.avif' },
      { nombre: 'Pólizas anuales de mantenimiento',   sub: 'Contratos con precio preferencial, cobertura integral y prioridad de atención — la opción más rentable para empresas', img: '/imagenes/servicios/mantenimiento-preventivo-extintores-poliza-anual.avif' },
    ],
    normasEyebrow: 'Cumplimiento normativo',
  ...
  'instalacion-sistemas': {
    ...
    detalles: [
      { nombre: 'Instalación de alarmas contra incendio', sub: 'Sistemas convencionales y analógico-direccionables con programación, cableado y puesta en marcha certificada NFPA 72', href: '/sistemas/', img: '/imagenes/sistemas/alarmas.jpg' },
      { nombre: 'Instalación de detectores de humo',     sub: 'Detectores iónicos, fotoeléctricos y termovelocimétricos — selección técnica según el tipo de riesgo de cada zona', href: '/sistemas/', img: '/imagenes/sistemas/detectores.jpg' },
      { nombre: 'Rociadores automáticos NFPA 13',        sub: 'Diseño e instalación de sistemas húmedos, secos y de diluvio para naves industriales, bodegas y edificios comerciales', href: '/sistemas/', img: '/imagenes/sistemas/rociadores.jpg' },
      { nombre: 'Redes hidráulicas contra incendio',     sub: 'Ingeniería, tendido de tubería y pruebas de presión para redes de rociadores y gabinetes de hidrante', href: '/sistemas/', img: '/imagenes/sistemas/redes-hidraulicas.jpg' },
      { nombre: 'Tableros de control y monitoreo',       sub: 'Paneles FACP y controladores de bomba NFPA 20 con supervisión remota, diagnóstico en tiempo real y respaldo', href: '/sistemas/', img: '/imagenes/sistemas/tableros.jpg' },
      { nombre: 'Visita técnica sin costo',              sub: 'Un ingeniero evalúa tu instalación, define el alcance del proyecto y te entrega presupuesto detallado sin compromiso', img: '/imagenes/servicios/asesoria-tecnica-proteccion-civil-dictamen-seguridad.avif' },
    ],
    normasEyebrow: 'Cumplimiento normativo',
    normasTitleLine1: 'Normas que',
  ...
  'prueba-hidrostatica': {
    ...
    detalles: [
      { nombre: 'Prueba de presión NOM-154-SCFI',     sub: 'Ensayo hidrostático certificado que verifica la resistencia estructural del cilindro a presión superior a la de servicio', img: '/imagenes/servicios/prueba-hidrostatica-extintores-nom-154-certificado.avif' },
      { nombre: 'Detección de corrosión interna',     sub: 'Identificamos daño oculto, micro-fisuras y debilitamiento del metal que una inspección visual no puede detectar', img: '/imagenes/extintores/extintor-polvo-seco-pqs-instalado-oficina-cdmx.avif' },
      { nombre: 'Certificado oficial para expediente', sub: 'Documento con número de folio, resultados y firma del técnico responsable — aceptado por Protección Civil sin observaciones', img: '/imagenes/extintores/venta-extintor-pqs-abc-certificado-nom-mexico.avif' },
      { nombre: 'Cobertura para todos los agentes',   sub: 'PQS, CO₂, AFFF, Tipo K y agente limpio — cada tipo de extintor requiere esta prueba obligatoria cada 5 años', img: '/imagenes/extintores/extintor-co2-dioxido-carbono-equipo-electrico-cdmx.avif' },
      { nombre: 'Dictamen técnico fundamentado',      sub: 'Reporte detallado con resultado aprobatorio o rechazo documentado con causa técnica y recomendación de reemplazo', img: '/imagenes/servicios/asesoria-tecnica-proteccion-civil-dictamen-seguridad.avif' },
      { nombre: 'Reemplazo inmediato garantizado',    sub: 'Si el cilindro no supera la prueba, te ofrecemos un extintor nuevo al momento — tu empresa nunca queda desprotegida', img: '/imagenes/servicios/venta-equipo-contra-incendio-certificado-cdmx.avif' },
    ],
    normasEyebrow: 'Cumplimiento normativo',
  ...
  'asesoria-tecnica': {
    ...
    detalles: [
      { nombre: 'Evaluación de riesgo NOM-002-STPS', sub: 'Clasificamos tu instalación como riesgo bajo, medio u ordinario para determinar el equipo y las medidas exactas que requieres', img: '/imagenes/escenarios/industrial.avif' },
      { nombre: 'Recomendación técnica de extintores', sub: 'Definimos tipo de agente, capacidad, cantidad y ubicación óptima por cada zona de tu inmueble según normativa vigente', img: '/imagenes/extintores/extintor-polvo-seco-pqs-instalado-oficina-cdmx.avif' },
      { nombre: 'Diagnóstico de señalización NOM-003', sub: 'Identificamos señalamientos faltantes o mal ubicados y te entregamos un plano con las correcciones necesarias', img: '/imagenes/senalamientos/senalamientos-hero.jpg' },
      { nombre: 'Preparación para inspecciones',     sub: 'Revisamos tu expediente completo de seguridad para que pases la visita de Protección Civil sin observaciones ni multas', img: '/imagenes/servicios/asesoria-tecnica-proteccion-civil-dictamen-seguridad.avif' },
      { nombre: 'Plan de equipamiento por etapas',    sub: 'Presupuesto priorizado que te permite regularizarte de forma gradual — primero lo urgente, después lo complementario', img: '/imagenes/escenarios/oficina.avif' },
      { nombre: 'Expediente técnico integrado',       sub: 'Documentación profesional con fichas, certificados y planos listos para entregar ante cualquier autoridad regulatoria', img: '/imagenes/extintores/venta-extintor-pqs-abc-certificado-nom-mexico.avif' },
    ],
  ...
  'capacitacion': {
    ...
    detalles: [
      { nombre: 'Curso de uso y manejo de extintores',  sub: 'Práctica con fuego real supervisada por instructores certificados — tu personal aprende a actuar en los primeros 60 segundos críticos', img: '/imagenes/extintores/extintor-polvo-seco-pqs-instalado-oficina-cdmx.avif' },
      { nombre: 'Formación de brigadas de emergencia',  sub: 'Programa integral para brigadas contra incendio, evacuación y primeros auxilios con roles definidos y protocolos claros', img: '/imagenes/equipo-bomberos/trajes-estructurales-nfpa-1971.avif' },
      { nombre: 'Simulacros de evacuación cronometrados', sub: 'Escenarios reales con medición de tiempos, identificación de cuellos de botella y reporte de mejoras para tu plan interno', img: '/imagenes/escenarios/oficina.avif' },
      { nombre: 'Constancias DC-3 con validez STPS',    sub: 'Documentos oficiales que acreditan la capacitación de tu personal — requisito obligatorio en auditorías laborales', img: '/imagenes/servicios/capacitacion-brigadas-contra-incendio-constancia-dc3.avif' },
      { nombre: 'Capacitación en primeros auxilios',    sub: 'Protocolos de atención inicial, uso de botiquín STPS, inmovilización y técnicas de reanimación para emergencias reales', img: '/imagenes/primeros-auxilios/botiquin.jpg' },
      { nombre: 'Cursos impartidos en tus instalaciones', sub: 'El instructor trabaja directamente con tu equipo y tus extintores — capacitación práctica, no solo teoría de aula', img: '/imagenes/equipo-bomberos/herramientas-rescate-bombero.avif' },
    ],
    normasEyebrow: 'Marco normativo',
    normasTitleLine1: 'Normas que',
    normasTitleLine2: 'cumplimos',
  ...
  'senalizacion': {
    ...
    detalles: [
      { nombre: 'Señalización de rutas de evacuación', sub: 'Flechas y letreros fotoluminiscentes que guían al personal hacia las salidas incluso en cortes de energía eléctrica', href: '/senalamientos/', img: '/imagenes/senalamientos/escaleras-emergencia.jpg' },
      { nombre: 'Señales de ubicación de extintores',   sub: 'Señalamientos de salvación en acrílico o PVC que identifican cada punto de equipo contra incendio en tu inmueble', href: '/senalamientos/', img: '/imagenes/senalamientos/letrero-extintor.jpg' },
      { nombre: 'Señales de prohibición NOM-026',       sub: 'No fumar, no paso, no encender fuego y restricciones específicas — fabricadas con tintas resistentes a UV', href: '/senalamientos/', img: '/imagenes/senalamientos/prohibicion.jpg' },
      { nombre: 'Señales de advertencia de riesgo',     sub: 'Riesgo eléctrico, material inflamable, sustancias peligrosas y más — visibilidad inmediata en zonas críticas', href: '/senalamientos/', img: '/imagenes/senalamientos/advertencia.jpg' },
      { nombre: 'Instalación conforme a norma oficial', sub: 'Colocación a la altura, distancia y ubicación exactas que exigen NOM-003-SEGOB y NOM-026-STPS vigentes', img: '/imagenes/senalamientos/salida-emergencia.jpg' },
      { nombre: 'Plano de señalización para expediente', sub: 'Levantamiento completo de tu inmueble con ubicación de cada señal — documento listo para Protección Civil', img: '/imagenes/senalamientos/punto-reunion.jpg' },
    ],
    normasEyebrow: 'Cumplimiento normativo',
