---
title: "Seguridad contra incendios en condominios y edificios"
description: "Guia completa sobre seguridad contra incendios en condominios y edificios residenciales en Mexico, incluyendo normatividad, equipo requerido y planes de evacuacion."
pubDate: 2025-09-10
category: "Seguridad"
---

Los condominios y edificios residenciales en Mexico presentan desafios unicos en materia de proteccion contra incendios. La concentracion de multiples familias en un mismo inmueble, las areas comunes compartidas, los estacionamientos subterraneos y las instalaciones de gas centralizadas crean un escenario de riesgo que requiere un enfoque integral de prevencion. Los reglamentos de construccion de la Ciudad de Mexico y otras entidades establecen requisitos especificos para edificaciones residenciales que varian segun la altura, el numero de departamentos y el tipo de ocupacion.

El equipamiento requerido depende directamente de la altura y superficie del edificio. Las edificaciones de hasta cuatro niveles generalmente requieren extintores en areas comunes, senalizacion de rutas de evacuacion, detectores de humo en pasillos y un sistema de alarma manual. A partir de cinco niveles, la normatividad exige ademas tomas siamesas para bomberos, red de hidrantes interiores, sistema de deteccion y alarma automatica, alumbrado de emergencia en escaleras y pasillos, y en muchos casos un sistema de presurizacion de escaleras que impide la entrada de humo a las rutas de evacuacion.
